...
public class Gyro extends AHRS {
	...
	public double getCurrentAngle() {
		return Compass.validate(-(double) getAngle());
	}
	 ...
	 * @return arc measure in degrees (positive if the arc is clockwise of current,
	 *         negative otherwise)
	...
	public double netAcceleration() {
		final double xx_yy = (double) (getWorldLinearAccelX() * getWorldLinearAccelX()
				+ getWorldLinearAccelY() * getWorldLinearAccelY());

...
public class RedRightCubePlaceAndGrab extends SequentialCommandGroup {
  ...
  PathPlannerTrajectory autoPath1 = PathPlanner.loadPath("Red Right Cube Place And Grab", 1, 1);
  ...
  public RedRightCubePlaceAndGrab() {

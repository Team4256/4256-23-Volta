...
public class RedCubePlaceAndMove extends SequentialCommandGroup {
  ...
  PathPlannerTrajectory autoPath1 = PathPlanner.loadPath("Red Cube Place And Move", 2, 1.5);
